...
const CatogoryTracks = () =>  {
  ...
  return (
    <div className={`w-[100%] bg-[url('/catogory1.jpg')] xs:pl-5 sm:pl-20 pr-10 bg-cover min-h-screen pb-40 pt-10 bg-[rgba(0,0,0,0.7)] bg-blend-multiply `}>
        <h1 className='text-white xs:text-4xl sm:text-6xl font-cursive font-light '>Listen to {catogory.name} Music <FontAwesomeIcon icon={faMusic} color='rgba(200,0,20,0.5)'/></h1>
        <h2 className='sm:ml-16 text-2xl text-red-600 font-body mt-2'> {catogory.description}</h2>
